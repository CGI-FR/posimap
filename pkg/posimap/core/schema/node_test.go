...
func Example() {
	...
	// 	"ROOT.PERSON" -> "ROOT.PERSON.LASTNAME" [style=dashed constraint=false color=red label=16];
	// 	"ROOT" [label = "ROOT\n150"];
	...
	// 	"ROOT.ADDRESSES.LINE-1" -> "ROOT.PERSON" [style=dashed constraint=false color=red label=16];
