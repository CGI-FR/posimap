...
func Example() {
	...
	rootFiller := schema2.NewField("FILLER", codec.NewString(charmap.ISO8859_1, 27, true))
	...
	// 	"ROOT" -> "ROOT.ISCOMPANY";
	// 	"ROOT.ISCOMPANY" -> "ROOT.ADDRESSES" [style=dashed constraint=false color=red label=70];
	// 	"ROOT" [label = "ROOT\n100"];
	// 	"ROOT.TITLES" [label = "TITLES\n2"];
	// 	"ROOT" -> "ROOT.TITLES";
	// 	"ROOT.TITLES" -> "ROOT.ISCOMPANY" [style=dashed constraint=false color=red label=71];
	// 	"ROOT" [label = "ROOT\n100"];
	// 	"ROOT.FILLER" [label = "FILLER\n27"];
	// 	"ROOT" -> "ROOT.FILLER";
	// 	"ROOT.FILLER" -> "ROOT.TITLES" [style=dashed constraint=false color=red label=73];
	// 	"ROOT" -> "ROOT.FILLER" [style=dashed constraint=false color=red label=100];
	// }
}
